...
WEB_SERVICE='nginx'
CONFIG_FILE='/<path>/nodefony/config/letsencrypt/webroot.ini'
echo $CONFIG_FILE
#path to letsencrypte exe
LE_PATH='/usr/bin/letsencrypt'
EXP_LIMIT=90;
...
CERT_FILE="/<path>/nodefony/config/certificates/letsencrypt/$DOMAIN/fullchain.pem"
echo $CERT_FILE
