...
cp -r $ROOT_CA/certs/ca.cert.pem $ROOT_DIR/ca/nodefony-root-ca.crt.pem
cp -r $ROOT_CA/private/ca.key.pem $ROOT_DIR/ca/nodefony-root-ca.key.pem
...
cp -r $ROOT_CA_INTERMEDIATE/private/nodefony.key.pem $ROOT_DIR/server/privkey.pem
cp -r $ROOT_CA_INTERMEDIATE/certs/server.nodefony.cert.pem $ROOT_DIR/server/cert.pem
