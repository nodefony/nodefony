class seedeersTask extends nodefony.Task {
  ...
  async executed (connector) {
    ...
    return new Promise((resolve, reject) => {
      try {
        this.sequelizeService.once("onOrmReady", async () => resolve(await this.umzugService.executed(connector, true, "seedeers")));
      } catch (e) {
        return reject(e);
      }
    });
  ...
  async pending (connector) {
    ...
    return new Promise((resolve, reject) => {
      try {
        this.sequelizeService.once("onOrmReady", async () => resolve(await this.umzugService.pending(connector, true, "seedeers")));
      } catch (e) {
        return reject(e);
      }
    });
  ...
  async up (connector) {
    ...
    this.sequelizeService.once("onOrmReady", async () => await this.umzugService.up(connector, {}, "seedeers"));
  }
  ...
  async down (connector) {
    ...
    this.sequelizeService.once("onOrmReady", async () => await this.umzugService.down(connector, {}, "seedeers"));
  }
  ...
  async revert (connector) {
    ...
    this.sequelizeService.once("onOrmReady", async () => await this.umzugService.revertAll(connector, "seedeers"));
  }
  ...
  async create (connector, name) {
    ...
    this.sequelizeService.once("onOrmReady", async () => await this.umzugService.createSeedeers(connector, name));
  }
}
