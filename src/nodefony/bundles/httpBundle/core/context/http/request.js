...
module.exports = nodefony.register("Request", function () {
    ...
    const Request = class Request {
        ...
        parserRequest() {
            this.formidable = formidable.IncomingForm({
            ...
            this.formidable.parse(this.request, (err, fields, files) => {
                ...
                if (Object.keys(files).length) {
                    this.queryFile = files;
                    for (let file in this.queryFile) {
                        this.queryFile[file] = this.context.uploadService.createUploadFile(this.queryFile[file]);
                    }
                }
