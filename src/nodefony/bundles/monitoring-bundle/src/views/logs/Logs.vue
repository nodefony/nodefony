<template >
<v-container v-if="logs" fluid class="w-100 pa-0 h-100" style="position:absolute">

  <v-toolbar color="#233056" theme="dark" extended flat>
    <v-app-bar-title>
      Syslog
      <v-badge color="info" v-if="nbLogs" :content="nbLogs" inline>
      </v-badge>
    </v-app-bar-title>
    <v-card-subtitle>Syslog</v-card-subtitle>
    <template v-slot:prepend>
      <v-icon size="50" color="#43853d" rounded="0">mdi-math-log</v-icon>
    </template>
