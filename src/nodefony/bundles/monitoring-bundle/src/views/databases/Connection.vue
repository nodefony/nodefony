  ...
  <v-card v-if="connector"
    ...
    <v-toolbar theme="dark"
      ...
      <v-chip :color="colorConnect"
              density="compact">{{connector.state}}</v-chip>
      ...
      <v-row>
        <v-col>
          ...
          <v-list density="compact"
            ...
            <v-list-item v-if="connector.type== 'sqlite'"
                         lines="two"
                         class="text-caption"
                         density="compact">
              <v-list-item-header class="text-subtitle-2">
        ...
        <v-divider v-if="!widget"
                   class=""
                   vertical></v-divider>
        <v-col v-if="!widget">
          <div> Options</div>
          <v-list>
            <div v-for="(value, key) in connector.settings.options "
                 :key="key">
              <v-list-item v-if="key !== 'storage'"
                           class="text-caption">
                <v-list-item-header class="text-subtitle-2">
