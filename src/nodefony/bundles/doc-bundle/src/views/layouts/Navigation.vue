...
<v-navigation-drawer v-model="drawer" width="300" app>
  ...
  <v-list density="compact" nav class="ma-0 pa-0">
    ...
    <v-list-group v-if="isAdmin">
      ...
      <v-list-item prepend-icon="mdi-account-multiple" title="users" value="users" to="/bundle/users"></v-list-item>
    ...
    <v-list-group v-if="isAdmin">
      <template v-slot:activator="{ props }">
        <v-list-item v-bind="props" prepend-icon="mdi-view-module-outline" title="Services" value="services"></v-list-item>
      </template>
    ...
    <v-list-group v-if="isAdmin">
      ...
      <v-list-item prepend-icon="mdi-monitor-dashboard" title="Dashboard" value="dashboardProfiling" to="/monitoring/dashboard">
      </v-list-item>
    </v-list-group>
    ...
    <v-list-group v-if="isAdmin">
      ...
      <v-list-item prepend-icon="mdi-monitor-dashboard" title="Dashboard" value="DashboardMonitoring">
      </v-list-item>
    </v-list-group>
