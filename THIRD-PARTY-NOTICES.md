...
| `@nodefony/drizzle` | 10.0.0-alpha.8 | Apache-2.0 |
| `@nodefony/framework` | 10.0.0-alpha.8 | Apache-2.0 |
| `@nodefony/frontend` | 10.0.0-alpha.8 | Apache-2.0 |
| `@nodefony/http` | 10.0.0-alpha.8 | Apache-2.0 |
| `@nodefony/orm-core` | 10.0.0-alpha.8 | Apache-2.0 |
| `@nodefony/realtime` | 10.0.0-alpha.8 | Apache-2.0 |
| `@nodefony/redis` | 10.0.0-alpha.8 | Apache-2.0 |
| `@nodefony/security` | 10.0.0-alpha.8 | Apache-2.0 |
| `@nodefony/studio` | 10.0.0-alpha.8 | Apache-2.0 |
| `@nodefony/user` | 10.0.0-alpha.8 | Apache-2.0 |
