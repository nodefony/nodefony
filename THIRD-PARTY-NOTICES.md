...
Cette application redistribue 156 paquets tiers. Les licences
...
| --- | ---: | --- |
| MIT | 128 | garder la notice et le texte de la licence |
| Apache-2.0 | 13 | garder la notice et le fichier NOTICE ; signaler les fichiers modifiés (brevets concédés) |
| BSD-3-Clause | 6 | garder la notice ; ne pas invoquer le nom des auteurs pour promouvoir |
| ISC | 6 | garder la notice et le texte de la licence |
| 0BSD | 2 | rien — attribution non exigée |
| BlueOak-1.0.0 | 1 | garder la notice et le texte de la licence |
...
| `@nodefony/drizzle` | 10.0.0-alpha.9 | Apache-2.0 |
| `@nodefony/framework` | 10.0.0-alpha.9 | Apache-2.0 |
| `@nodefony/frontend` | 10.0.0-alpha.9 | Apache-2.0 |
| `@nodefony/http` | 10.0.0-alpha.9 | Apache-2.0 |
| `@nodefony/orm-core` | 10.0.0-alpha.9 | Apache-2.0 |
| `@nodefony/realtime` | 10.0.0-alpha.9 | Apache-2.0 |
| `@nodefony/redis` | 10.0.0-alpha.9 | Apache-2.0 |
| `@nodefony/security` | 10.0.0-alpha.9 | Apache-2.0 |
| `@nodefony/studio` | 10.0.0-alpha.9 | Apache-2.0 |
| `@nodefony/user` | 10.0.0-alpha.9 | Apache-2.0 |
| `@peculiar/asn1-android` | 2.9.5 | MIT |
...
| `@simplewebauthn/server` | 14.0.2 | MIT |
